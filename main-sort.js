...
console.log("1. Нерозріджений масив (100 елементів) ", "background: #ff00ff; color: #fff");
...
console.log("2. Розріджений масив (100 елементів) ", "background: #ff00ff; color: #ff69b4");
